...
│                                  └────┘ └────┘ └────┘                  │
│                                                                          │
│  ► Service непрерывно направляет трафик на Ready Pod'ы:                 │
│    На каждом шаге Service видит Pod'ы обоих ReplicaSet'ов               │
│    (по label selector) и балансирует только между Ready Pod'ами.        │
│    Пользователи не видят downtime.                                      │
│                                                                          │
└─────────────────────────────────────────────────────────────────────────┘
```
